...
python3 /data2/castri/fcs-gx-0.5.0/fcs.py screen genome --fasta ${ASSEMBLY} --out-dir ${OUT_DIR} --gx-db /data2/castri/fcs-gx-0.5.0/gxdb --tax-id ${TAX_ID} --generate-logfile T