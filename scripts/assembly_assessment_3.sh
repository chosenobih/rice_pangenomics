...
java -jar /data2/castri/tools/jvarkit/jvarkit.jar wgscoverageplotter --dimension 3000x1000 -C -1 --clip -R ${ASSEMBLY_PATH}/${ASSEMBLY}.fa ${ASSEMBLY_PATH}/HiFi2_${ASSEMBLY}_sorted.bam --percentile median --min-contig-length 1000000 >  ./Assembly_Assessment_${ASSEMBLY}/${ASSEMBLY}.svg
